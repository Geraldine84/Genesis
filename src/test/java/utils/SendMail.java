...
public class SendMail {
    ...
    public static void ComposeGmail(String fromMail, String toMail) {
        ...
        try {
            ...
            message.setSubject("Genesis Automated Test Result");
            MimeBodyPart messageBodyPart = new MimeBodyPart();
            messageBodyPart.setText("Hello," + "\n" + "Attached to this mail is the report of an automated test on Genesis Android.");
            Multipart multipart = new MimeMultipart();
            multipart.addBodyPart(messageBodyPart);
            messageBodyPart = new MimeBodyPart();
            String file = System.getProperty("user.dir") + "/DroidReport.html";
            String fileName = "Genesis-Android.html";
            ...
            Transport.send(message, "nwabudegeraldine@gmail.com", "KAKAA!!!");
